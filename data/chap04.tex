...
\begin{figure}[!htbp]
  \centering
  \includegraphics[width=0.75\linewidth]{problem.pdf}
...
\begin{figure}[!htbp]
  \centering
  \subcaptionbox{三维能量分布\label{fig:tpf_3d}}{\includegraphics[width=0.45\linewidth]{blue_E.pdf}}
  \hfill
  \subcaptionbox{俯视等高线投影\label{fig:tpf_top}}{\includegraphics[width=0.45\linewidth]{asdads.pdf}}
...
\begin{figure}[!htbp]
  \centering
  \includegraphics[width=0.72\linewidth]{position.pdf}
...
\begin{figure}[!htbp]
  \centering
  \includegraphics[width=0.95\linewidth]{model1.pdf}
...
\begin{figure}[!htbp]
  \centering
  \subcaptionbox{Actor 网络\label{fig:actor_net}}{\includegraphics[width=0.3\linewidth]{left.pdf}}
  \hfill
  \subcaptionbox{Critic 网络 (含 MHA)\label{fig:critic_net}}{\includegraphics[width=0.42\linewidth]{right.pdf}}
...
\begin{figure}[!htbp]
  \centering
  \subcaptionbox{平均奖励\label{fig:hunt_reward}}{\includegraphics[width=0.44\linewidth]{reward}}
  \hfill
  \subcaptionbox{价值损失\label{fig:hunt_vloss}}{\includegraphics[width=0.44\linewidth]{value_loss}}

  \vspace{8pt}
  \subcaptionbox{策略损失\label{fig:hunt_ploss}}{\includegraphics[width=0.44\linewidth]{policy_loss}}
  \hfill
  \subcaptionbox{策略熵损失\label{fig:hunt_ent}}{\includegraphics[width=0.44\linewidth]{entropy}}
...
\begin{figure}[!htbp]
  \centering
  \subcaptionbox{确定性算法\label{fig:hunt_det}}{\includegraphics[width=0.45\linewidth]{path3}}
  \hfill
  \subcaptionbox{启发式算法\label{fig:hunt_heu}}{\includegraphics[width=0.45\linewidth]{path2}}

  \vspace{6pt}
  \subcaptionbox{本文 MHD-MAPPO\label{fig:hunt_ours}}{\includegraphics[width=0.45\linewidth]{path1}}
  \hfill
  \subcaptionbox{追逃距离曲线\label{fig:hunt_dist}}{\includegraphics[width=0.45\linewidth]{path1_data}}
...
\begin{figure}[!htbp]
  \centering
  \subcaptionbox{$t=20$ s (接近阶段)\label{fig:hunt_t20}}{\includegraphics[width=0.31\linewidth]{pic1}}
  \hfill
  \subcaptionbox{$t=50$ s (成型阶段)\label{fig:hunt_t50}}{\includegraphics[width=0.31\linewidth]{pic2}}
  \hfill
  \subcaptionbox{$t=80$ s (保持阶段)\label{fig:hunt_t80}}{\includegraphics[width=0.31\linewidth]{pic3}}
...
\begin{figure}[!htbp]
  \centering
  \includegraphics[width=0.75\linewidth]{exper}
...
\begin{figure}[!htbp]
  \centering
  \subcaptionbox{追击者纵向速度\label{fig:hunt_v}}{\includegraphics[width=0.8\linewidth]{v}}

  \vspace{4pt}
  \subcaptionbox{追击者艏向角速度\label{fig:hunt_yaw}}{\includegraphics[width=0.8\linewidth]{yawspeed}}
